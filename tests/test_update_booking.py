...
class TestUpdateBooking:
    ...
    def test_put_003(self, request_context, auth_token, api_headers, api_headers_with_cookie):
        r = update_booking(request_context, 999999, headers=api_headers_with_cookie(auth_token))
    ...
    def test_patch_001(self, request_context, auth_token,
                       api_headers, api_headers_with_cookie):
        r = create_booking(request_context, headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "bookingid")
    ...
    def test_patch_002(self, request_context, auth_token,
                       api_headers, api_headers_with_cookie):
        r = create_booking(request_context, headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "bookingid")
