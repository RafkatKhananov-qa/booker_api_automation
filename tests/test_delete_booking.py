...
class TestDeleteBooking:
    ...
    def test_del_001_002(self, request_context, auth_token,
    ...
    def test_del_003(self, request_context, auth_token,
                     api_headers, api_headers_with_cookie):
        r = delete_booking(request_context, 4575765756,
                           headers=api_headers_with_cookie(auth_token))
    ...
    def test_del_006(self, request_context, auth_token,
                     api_headers, api_headers_with_cookie):
        r = create_booking(request_context, headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "bookingid")
    ...
    def test_del_007(self, request_context, auth_token,
                     api_headers, api_headers_with_cookie):
        r = create_booking(request_context, headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "bookingid")
