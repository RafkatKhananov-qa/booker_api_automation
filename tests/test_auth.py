...
class TestAuth:
    ...
    def test_auth_001(self, api_headers):
    ...
    def test_auth_002(self, api_headers):
    ...
    def test_auth_003(self, api_headers):
    ...
    def test_auth_004(self, api_headers, api_headers_with_cookie):
        r = create_token(headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "token")
        token = r.json()["token"]
    ...
    def test_auth_005(self, api_headers, api_headers_with_cookie):
        r = create_token(headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "token")
    ...
    def test_auth_006(self, api_headers):
        r = create_token(headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "token")
    ...
    def test_auth_007(self, api_headers):
        r = create_token(headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "token")
    ...
    def test_auth_008(self, api_headers):
        r = create_token(headers=api_headers)
        assert_status_code(r, 200)
        assert_field_in_response_message(r, "token")
        assert_field_value_type(r, "token", str)
